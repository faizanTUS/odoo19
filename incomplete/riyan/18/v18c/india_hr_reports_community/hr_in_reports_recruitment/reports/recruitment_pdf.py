...
class ReportRecFunnel(models.AbstractModel):
    _name = "report.india_hr_reports_community.pay_rec_funnel_document"
...
class ReportRecTth(models.AbstractModel):
    _name = "report.india_hr_reports_community.pay_rec_tth_document"
...
class ReportRecSource(models.AbstractModel):
    _name = "report.india_hr_reports_community.pay_rec_source_document"
