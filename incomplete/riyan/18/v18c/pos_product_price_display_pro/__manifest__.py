...
# -*- coding: utf-8 -*-
{
    'name': 'POS Product Price Display Control | Show Price With or Without Tax on Product Cards',
    'version': '18.0.0.0',
    ...
    """,
    'description': """
POS Product Price Display Control | Show Price With or Without Tax on Product Cards
...
sales tax, depending on your business needs or regional requirements.
    ...
    'assets': {
        'point_of_sale._assets_pos': [
            'pos_product_price_display_pro/static/src/app/generic_components/product_card/product_card.xml',
            'pos_product_price_display_pro/static/src/app/generic_components/product_card/product_card.js',
            'pos_product_price_display_pro/static/src/app/screens/product_screen/product_screen.xml',
            'pos_product_price_display_pro/static/src/app/screens/product_screen/product_screen.js',
            'pos_product_price_display_pro/static/src/app/store/pos_redirect_patch.js',
        ],
    },
    "images": [
