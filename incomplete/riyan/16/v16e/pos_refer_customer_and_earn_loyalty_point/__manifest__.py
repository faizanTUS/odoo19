...
{
    'name': 'POS Customer Referral & Loyalty Rewards | Refer & Earn Points | Odoo Point of Sale',
    'version': '16.0.0.0',
    ...
    techultra solutions private limited
    """,
    'depends': ['base', 'loyalty', 'point_of_sale', 'pos_loyalty', 'mail'],
    'data': [
    ...
    'assets': {
        'point_of_sale.assets': [
            'pos_refer_customer_and_earn_loyalty_point/static/src/js/**/*',
            'pos_refer_customer_and_earn_loyalty_point/static/src/xml/**/*',
        ],
    },
    "images": [
    ...
    'price': 25.00,
    'currency': 'EUR',
    'post_init_hook': '_generate_referral_code_post_init',
    'installable': True,
    'application': True,
    'auto_install': False,
    'license': 'OPL-1',
