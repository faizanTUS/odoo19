...
class HrInReportWizardLeaveLedger(models.TransientModel):
    ...
    def _pdf_report_xmlid(self):
        return "india_hr_reports_community.action_report_leave_ledger"
...
class HrInReportWizardLeaveBalance(models.TransientModel):
    ...
    def _pdf_report_xmlid(self):
        return "india_hr_reports_community.action_report_leave_balance"
    ...
    def _get_dataset(self):
        ...
        return {
            "title": _("Leave balance (allocations as-of)"),
...
class HrInReportWizardLeaveAccrual(models.TransientModel):
    ...
    def _pdf_report_xmlid(self):
        return "india_hr_reports_community.action_report_leave_accrual"
    ...
    def _get_dataset(self):
        ...
        return {
            "title": _("Accrual allocation audit"),
