...
class HrInReportWizardAttDaily(models.TransientModel):
    ...
    def _pdf_report_xmlid(self):
        return "india_hr_reports_community.action_report_att_daily"
...
class HrInReportWizardAttMonthly(models.TransientModel):
    ...
    def _pdf_report_xmlid(self):
        return "india_hr_reports_community.action_report_att_monthly"
    ...
    def _get_dataset(self):
        ...
        if (self.date_to - self.date_from).days > 62:
            ...
            raise UserError(_("Pick a period of 62 days or less for the matrix export."))
        days = []
        d = self.date_from
...
class HrInReportWizardAttExceptions(models.TransientModel):
    ...
    def _pdf_report_xmlid(self):
        return "india_hr_reports_community.action_report_att_exceptions"
...
class HrInReportWizardAttOvertime(models.TransientModel):
    ...
    def _pdf_report_xmlid(self):
        return "india_hr_reports_community.action_report_att_ot"
