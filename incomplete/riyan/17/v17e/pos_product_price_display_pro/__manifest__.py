...
sales tax, depending on your business needs or regional requirements.
    ...
    'assets': {
        'point_of_sale._assets_pos': [
            'pos_product_price_display_pro/static/src/js/products_widget_patch.js',
            'pos_product_price_display_pro/static/src/xml/product_card.xml',
            'pos_product_price_display_pro/static/src/xml/products_widget.xml',
        ],
    },
    "images": [
