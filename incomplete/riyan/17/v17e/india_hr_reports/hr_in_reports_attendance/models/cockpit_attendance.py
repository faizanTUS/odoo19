    ...
    def collect(env, filters):
        ...
        return {
            ...
            "kpis": [
                {
                    "key": "att_lines",
                    "label": _("Attendance lines"),
                    "value": total_lines,
                    "hint": _("In selected period"),
                },
                {
                    "key": "att_hours",
                    "label": _("Worked hours (sum)"),
                    "value": round(total_hours, 2),
                    "hint": _("Recorded on lines"),
                },
                {
                    "key": "att_open",
                    "label": _("Open check-ins"),
                    "value": open_count,
                    "hint": _("No check-out yet"),
                },
            ],
            "charts": charts,
        }
