...
class ProductTemplate(models.Model):
    ...
    def _get_additionnal_combination_info(self, product_or_template,uom, quantity, date, website):
        res = super()._get_additionnal_combination_info(product_or_template,uom, quantity, date, website)
    ...
    def _get_combination_info(
        self, combination=False,uom_id=False, product_id=False, add_qty=1.0, only_template=False,
    ):
