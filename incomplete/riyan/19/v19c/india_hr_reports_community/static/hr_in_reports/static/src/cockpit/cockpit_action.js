...
function activeCompanyIds() {
    return user.context?.allowed_company_ids || [user.activeCompany?.id].filter(Boolean);
}
...
export class HrInReportsCockpit extends Component {
    static components = { CockpitChart, MultiRecordSelector, CockpitDashCard };
    ...
    onEmployeesUpdate(resIds) {
        this.state.employeeIds = resIds;
    }

    onDepartmentsUpdate(resIds) {
        this.state.departmentIds = resIds;
    }

    onJobsUpdate(resIds) {
        this.state.jobIds = resIds;
    }
    ...
    static template = xml`
        <div class="o_hr_in_reports_cockpit o_action o_hr_dash-root d-flex flex-column h-100 overflow-hidden">
                    ...
                    <div class="row g-2 align-items-end">
                        <div class="col-12 col-lg-4">
                            ...
                            <MultiRecordSelector
                                ...
                                resIds="state.employeeIds"
                                update.bind="onEmployeesUpdate"
                                domain="employeeDomain"
                                placeholder="strings.phEmployees"
                            />
                        </div>
                        <div class="col-12 col-lg-4">
                            ...
                            <MultiRecordSelector
                                ...
                                resIds="state.departmentIds"
                                update.bind="onDepartmentsUpdate"
                                domain="departmentDomain"
                                placeholder="strings.phDepartments"
                            />
                        </div>
                        <div class="col-12 col-lg-3">
                            ...
                            <MultiRecordSelector
                                resModel="'hr.job'"
                                resIds="state.jobIds"
                                update.bind="onJobsUpdate"
                                domain="jobDomain"
                                placeholder="strings.phJobs"
                            />
                        </div>
            ...
            <div class="o_hr_dash-body flex-grow-1 overflow-auto bg-100">
                ...
                <t t-elif="layout">
                    <div class="o_hr_dash-kpis row row-cols-2 row-cols-md-3 row-cols-xl-4 g-3 p-3 pb-0">
...
registry.category("actions").add("india_hr_reports_community.cockpit", HrInReportsCockpit);
