...
class ReportLeaveLedgerPdf(models.AbstractModel):
    _name = "report.india_hr_reports_community.leave_pdf_report_ledger"
...
class ReportLeaveBalancePdf(models.AbstractModel):
    _name = "report.india_hr_reports_community.leave_pdf_report_balance"
...
class ReportLeaveAccrualPdf(models.AbstractModel):
    _name = "report.india_hr_reports_community.leave_pdf_report_accrual"
