...
class PurchaseOrderLine(models.Model):
    ...
    @api.depends('price_unit', 'multi_discount', 'discount', 'product_qty')
    def _compute_discount_amount(self):
        ...
        for line in self:
            ...
            # Calculate amounts
            line.discounted_total_amount = price_after_all_discounts * line.product_qty
            total_discount = (line.price_unit - price_after_all_discounts) * line.product_qty
