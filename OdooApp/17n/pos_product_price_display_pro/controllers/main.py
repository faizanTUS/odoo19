...
class PosManifestFix(http.Controller):
    ...
    def pos_manifest_fix(self, **kwargs):
        ...
        manifest = {
            ...
            "icons": [
                {
                    "src": f"{base_url}/pos_product_price_display_pro/static/img/pos-icon-192x192.png",
                    "sizes": "192x192",
                    "type": "image/png",
                    "purpose": "any maskable",
                },
                {
                    "src": f"{base_url}/pos_product_price_display_pro/static/img/pos-icon-512x512.png",
                    "sizes": "512x512",
                    "type": "image/png",
                    "purpose": "any maskable",
                },
