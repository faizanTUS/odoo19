...
class AdvancedAccessFormButton(models.Model):
    ...
    def search_fetch(self, domain, field_names, offset=0, limit=None, order=None):
        """Rebuild catalog when empty; Odoo 19 ``name_search`` uses ``search_fetch``, not ``search``."""
        ...
        return super(AdvancedAccessFormButton,self.with_context(aac_form_button_skip_rebuild_retry=True),).search_fetch(
