...
# Part of TechUltra Solutions. See LICENSE file for full copyright and licensing details.
{
    ...
    "summary": (
        "Odoo 18 form widget: drag-and-drop bulk upload for many2many ir.attachment fields—"
        "faster documents, PDFs, and images without extra dialogs."
    ),
    "description": """
Drag & Drop Multi File Upload for Many2many Binary Fields (Odoo 18)
====================================================================
...
-------------------------------------
Odoo 18 file upload, many2many attachment widget, ir.attachment drag and drop,
