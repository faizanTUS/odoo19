...
# -*- coding: utf-8 -*-
{
    ...
    "summary": """Community HR reporting hub: XLSX/PDF exports, cockpit dashboard, core HR reports
     ...
     Enterprise-only Payroll, India statutory, and Planning reports are gracefully replaced
     with informational notices.
...
Payroll, India statutory (PF/ESI/PT/LWF/TDS), and Planning registers are Enterprise-only and
are deliberately not bundled here. Menu placeholders direct users to the Enterprise edition
...
""",
    ...
    "assets": {
        "web.assets_backend": [
            # hr_in_reports
            "IndiaHrReportscommunity/static/hr_in_reports/static/src/scss/hr_in_cockpit_dashboard.scss",
            "IndiaHrReportscommunity/static/hr_in_reports/static/src/cockpit/cockpit_action.js",
        ],
        "web.report_assets_common": [
            # hr_in_reports
            "IndiaHrReportscommunity/static/hr_in_reports/static/src/scss/hr_in_report_pdf_professional.scss",

            # hr_in_reports_leave
            "IndiaHrReportscommunity/static/hr_in_reports_leave/static/src/scss/report_leave_pdf.scss",
        ],
    },
    "images": [
