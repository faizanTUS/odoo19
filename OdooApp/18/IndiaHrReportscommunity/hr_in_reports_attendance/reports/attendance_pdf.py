...
class ReportAttDailyPdf(models.AbstractModel):
    _name = "report.IndiaHrReportscommunity.att_pdf_daily_document"
...
class ReportAttMonthlyPdf(models.AbstractModel):
    _name = "report.IndiaHrReportscommunity.att_pdf_monthly_document"
...
class ReportAttExceptionsPdf(models.AbstractModel):
    _name = "report.IndiaHrReportscommunity.att_pdf_exceptions_document"
...
class ReportAttOtPdf(models.AbstractModel):
    _name = "report.IndiaHrReportscommunity.att_pdf_ot_document"
