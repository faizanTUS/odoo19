...
from odoo.addons.IndiaHrReportscommunity.hr_in_reports.models.cockpit_data import (
    cockpit_attendance_company_domain,
    cockpit_company_ids,
    cockpit_date_range,
    cockpit_hr_filters_attendance_domain,
)
from odoo.addons.IndiaHrReportscommunity.hr_in_reports.models.cockpit_registry import register_cockpit_provider
...
class AttendanceCockpitProvider:
    ...
    def collect(env, filters):
        ...
        day_rows = Att.read_group(base_dom, ['worked_hours:sum'], ["date:day"], orderby="date:day", lazy=False)
        count_rows = Att.read_group(base_dom, [], ["date:day"], orderby="date:day", lazy=False)
