...
# -*- coding: utf-8 -*-
{
    ...
    "summary": """Greet HR–aligned reporting hub: shared XLSX/PDF exports, cockpit, core HR reports 
...
""",
    ...
    "depends": ["hr", "web",  "hr_attendance", "hr_expense", "fleet", "hr_holidays",
    ...
    "assets": {
        "web.assets_backend": [
            # hr_in_reports
            "IndiaHrReports/static/hr_in_reports/static/src/scss/hr_in_cockpit_dashboard.scss",
            "IndiaHrReports/static/hr_in_reports/static/src/cockpit/cockpit_action.js",
        ],
        "web.report_assets_common": [
            # hr_in_reports
            "IndiaHrReports/static/hr_in_reports/static/src/scss/hr_in_report_pdf_professional.scss",

            # hr_in_reports_leave
            "IndiaHrReports/static/hr_in_reports_leave/static/src/scss/report_leave_pdf.scss",
