...
class ReportLeaveLedgerPdf(models.AbstractModel):
    _name = "report.IndiaHrReportscommunity.leave_pdf_report_ledger"
...
class ReportLeaveBalancePdf(models.AbstractModel):
    _name = "report.IndiaHrReportscommunity.leave_pdf_report_balance"
...
class ReportLeaveAccrualPdf(models.AbstractModel):
    _name = "report.IndiaHrReportscommunity.leave_pdf_report_accrual"
