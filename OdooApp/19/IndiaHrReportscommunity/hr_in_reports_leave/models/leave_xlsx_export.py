...
from odoo.addons.IndiaHrReportscommunity.hr_in_reports.models.hr_in_report_export_utils import build_xlsx_bytes, xlsx_attachment
...
def export_leave_xlsx_professional(record):
    ...
    header = {
        "title": ds.get("title") or env._("Report"),
        ...
        "footer": env._("Prepared on %(when)s - Prepared by %(who)s")
        % {
