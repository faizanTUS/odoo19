...
# Part of TechUltra Solutions. See LICENSE file for full copyright and licensing details.
{
    ...
    "summary": (
        "Odoo 19 form widget: drag-and-drop bulk upload for many2many ir.attachment fields—"
        "faster documents, PDFs, and images without extra dialogs."
    ),
    "description": """
Drag & Drop Multi File Upload for Many2many Binary Fields (Odoo 19)
====================================================================
...
* Optional **accepted_file_extensions** and **number_of_files** field options (same as core)
...
with widget ``many2many_binary_drag_and_drop`` (see module technical name / store listing).

**Search keywords (App Store / SEO)**
-------------------------------------
Odoo 19 file upload, many2many attachment widget, ir.attachment drag and drop,
