...
def _ageing_param_bool(Param, key, default=True):
    """Interpret ir.config_parameter as bool (missing key uses *default*)."""
    default_str = "True" if default else "False"
    raw = Param.get_param(key, default_str)
...
class ResConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        res.update(
            ...
            ageing_enable_vendor=_ageing_param_bool(Param, "ageing_alerts.enable_vendor", default=True),
            ageing_enable_customer=_ageing_param_bool(Param, "ageing_alerts.enable_customer", default=True),
...
class AccountAgeingAlertRunner(models.TransientModel):
    ...
    def run_daily_ageing_alert(self):
        ...
        enable_vendor = _ageing_param_bool(Param, "ageing_alerts.enable_vendor", default=True)
        enable_customer = _ageing_param_bool(Param, "ageing_alerts.enable_customer", default=True)
