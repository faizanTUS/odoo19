...
{
    'name': 'Advanced Inventory Backdate Control',
    'version': '16.0.0.0',
    'category': 'Inventory',
    'summary': """
    Backdate completed stock transfers while keeping original dates intact and ensuring user accountability with audit traceability.
    inventory backdate
    stock backdate
    ...
    """,
    'description': """
    This module allows authorized users to backdate done stock transfers (pickings and stock moves) and automatically records critical audit information such as the original completion date, the user who performed the backdate, and the reason for the change. This ensures transparency, traceability, and compliance with internal controls or audit requirements.
    inventory backdate
    stock backdate
    odoo inventory backdate
    stock transfer backdate
