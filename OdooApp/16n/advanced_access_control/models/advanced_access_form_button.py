...
class AdvancedAccessFormButton(models.Model):
    ...
    def _aac_catalog_rebuild_needed(self, domain):
        ...
        sudo_self = self.sudo().with_context(aac_form_button_skip_rebuild_retry=True)
    ...
    @api.model
    def _search(self, domain, offset=0, limit=None, count=False, order=None, access_rights_uid=None):
    ...
    def search_fetch(self, domain, field_names, offset=0, limit=None, order=None):
        """Rebuild catalog on empty search; Odoo 16 search_fetch is used by list views."""
    ...
    def rebuild_index(self):
        ...
        # Avoid recursion: our _search can call rebuild_index when the table is empty.
        # Use a context flag to disable rebuild-on-search while we're rebuilding.
        sudo_self = self.sudo().with_context(aac_form_button_skip_rebuild_retry=True)
