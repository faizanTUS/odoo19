...
The commission summary table is reserved for stacks that include the
``sale_commission`` module. This build focuses on quotations, deliveries,
invoices, and inactive customers.
