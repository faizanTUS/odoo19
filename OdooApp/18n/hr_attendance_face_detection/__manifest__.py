...
{
    'name': 'Face Recognition Attendance with GPS Tracking and Multi-Geofencing Control',
    'version': '18.0.0.2',
    'category': 'Human Resources',
    'summary': """
    Advanced AI-powered attendance tracking with facial recognition, liveness detection, and GPS location capture and Multi Geofencing Control
    ...
    remote workforce
    odoo integration
    Face Recognition Attendance with GPS Tracking and Multi Geofencing Control
    ...
    biometric attendance with face recognition
    ...
    employee attendance tracking software
    location based attendance system
    proxy attendance prevention system
...
Transform your employee attendance management with cutting-edge facial recognition technology. This comprehensive module provides secure, contactless, multi geofencing control, and automated attendance tracking that integrates seamlessly with Odoo's HR Attendance system.
...
- **Multi-Geofence Location Support**: Configure multiple geofence locations such as offices, branches, warehouses, factories, or project sites.
- **Geofencing Validation**: Attendance is allowed only within a configured geographic radius from the company location (latitude/longitude), ensuring on-site presence.
- **GPS Integration**: Automatic location capture and address resolution
- **Instant Attendance Logging**: Attendance records are created instantly with accurate timestamps.
- **Supports Multiple Work Locations**: Ideal for organizations with distributed teams, multiple branches, or field employees..
