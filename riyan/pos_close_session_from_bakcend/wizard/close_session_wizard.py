...
class CloseSessionWizard(models.TransientModel):
    ...
    expected_counted = fields.Float(related="payment_method_ids.expected_counted",string="Expected")
    counted = fields.Float(related="payment_method_ids.counted",string="Counted")
    is_default = fields.Boolean(related="payment_method_ids.is_default")
    differences = fields.Float(related="payment_method_ids.differences",string="differences")
    payment_type = fields.Char(related="payment_method_ids.payment_type")
