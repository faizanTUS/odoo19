...
#. Place the module under your addons tree. In this workspace the canonical
   path is ``odoo18/project/many2many_attachment_preview/`` — add the parent
...
#. Open **Apps**, clear the *Apps* filter, search for **Many2Many Attachment
   Preview** (or the technical name ``many2many_attachment_preview``).
#. Click **Activate**.
...
``many2many_attachment_preview`` folder inside it.
