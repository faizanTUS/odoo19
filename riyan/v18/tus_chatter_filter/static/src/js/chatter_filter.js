 ...
 * 
 * Provides high-quality, reactive filtering for Odoo 18 chatter.
            ...
            switch (chatterFilter) {
                case "communication":
                    ...
                    filtered = filtered.filter((m) =>
                        (m.message_type === "email" || m.is_discussion) &&
                        !m.is_note &&
                ...
                case "sent":
                    filtered = filtered.filter((m) =>
                        ...
                        !m.is_note &&
                        (m.isSelfAuthored || m.author?.isInternalUser)
                    );
                    break;
                case "received":
                    filtered = filtered.filter((m) =>
                ...
                case "system":
                    ...
                    break;
                case "notes":
                    filtered = filtered.filter((m) => m.is_note && m.message_type === "comment");
                    break;
                case "activities":
                    filtered = [];
                    break;
