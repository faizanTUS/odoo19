...
export class GlobalSearchPanel extends Component {
    ...
    getImageUrl(model, id) {
        return `/web/image?model=${model}&id=${id}&field=image_1920`;
    }
...
export class GlobalSearchSystray extends Component {
    setup() {
        ...
        onWillUnmount(() => this._closePopover());
    }
    ...
    openSearch() {
        ...
        this._popoverClose = this.popover.add(
            target,
            GlobalSearchPanel,
            {
...
GlobalSearchSystray.template = "tus_smart_global_search.GlobalSearchSystray";
GlobalSearchSystray.components = { GlobalSearchPanel };
GlobalSearchSystray.props = {};
