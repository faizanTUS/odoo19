...
class PettyCashFund(models.Model):
    ...
    def _compute_balance_metrics(self):
        ...
        for fund in self:
            ...
            if fund.petty_cash_account_id:
                ...
                balance = (data[0]["balance"] or 0.0) if data else 0.0
            ...
            pending_amount = (pending_vouchers[0]["amount"] or 0.0) if pending_vouchers else 0.0
            ...
            fund.monthly_spent = (spent[0]["amount"] or 0.0) if spent else 0.0
    ...
    def get_dashboard_kpis(self):
        ...
        monthly_spent = (monthly_data[0]["amount"] or 0.0) if monthly_data else 0.0
