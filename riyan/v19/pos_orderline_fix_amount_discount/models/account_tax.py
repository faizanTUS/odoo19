...
class AccountTax(models.Model):
    ...
    def _compute_taxes_for_single_line(self, base_line, handle_price_include=True, include_caba_tags=False,
        ...
        # Customisation
        discount_amount = 0
        if base_line.get('discount_amount', False):
            discount_amount = base_line.get('discount_amount')
        ...
        if taxes:
            ...
            to_update_vals = {
                ...
                'price_subtotal': taxes_res['total_excluded'] - discount_amount,
                'price_total': taxes_res['total_included'] - discount_amount,
            }
            ...
            to_update_vals = {
                ...
                'price_subtotal': price_subtotal - discount_amount,
                'price_total': price_subtotal - discount_amount,
            }
            tax_values_list = []
