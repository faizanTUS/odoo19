...
# -*- coding: utf-8 -*-
{
    ...
    """,
    "description": """
Smart Attachment Preview Pro with File Size Viewer | Chatter & Many2many Binary Viewer | PDF, Image, Video & Office Viewer for Odoo 17
========================================
...
preview, ir.attachment preview, chatter file viewer, productivity, Odoo 17.
...
installation, ``addons_path`` (``odoo17/project``), and ``web.base.url`` setup.
