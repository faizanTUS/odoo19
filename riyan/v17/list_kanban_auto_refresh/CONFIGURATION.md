...
Use this guide after installing **`list_kanban_auto_refresh`** on **Odoo 17**.
...
## 5. Downgrade from Odoo 18

If you migrate a database from **Odoo 18** with this module installed, install the **17.0** version from this folder on your **Odoo 17** `addons_path` and upgrade the module. Parameters `list_kanban_auto_refresh.enabled` and `list_kanban_auto_refresh.interval_ms` are preserved.
