# Features — Auto Refresh List & Kanban Views | Real-Time Data Reload (Odoo 17)
...
Odoo 17, list view auto refresh, kanban auto refresh, tree view reload, soft refresh, live list, live kanban, interval refresh, General Settings, productivity, CRM pipeline refresh, helpdesk queue, manufacturing board, real-time data without websocket.
