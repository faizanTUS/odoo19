# User wise Discuss Access Control | Hide Chat, Messaging & Discuss App — configuration guide
...
2. Go to **Apps**, remove the **Apps** filter, search for **User wise Discuss Access Control | Hide Chat, Messaging & Discuss App**.
