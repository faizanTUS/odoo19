...
# -*- coding: utf-8 -*-
{
    ...
    """,
    "description": """
User wise Discuss Access Control | Hide Chat, Messaging & Discuss App for Odoo 17
=========================================
...
**SEO / keywords**
------------------
Odoo 17, disable discuss, hide discuss, turn off chat, messaging menu, systray, live chat, per user, security group, privacy, UI cleanup, internal users.
