...
{
    "name": "Odoo Split View | Side-by-Side List & Form View Editor for Faster Record Navigation",
    "version": "17.0.0.0",
    ...
    "summary": """
    Odoo Split View enhances productivity by allowing users to view and edit records in a side-by-side split-screen layout without switching between list and form views. It provides a modern, synchronized interface that helps teams work faster and manage records more efficiently across multiple Odoo applications.
    tus
    techultra
    ...
    """,
    "description": """
    Odoo Split View is a powerful productivity module that allows users to view, navigate, and edit records in a seamless side-by-side split-screen layout. Users can open records in both vertical and horizontal split panels, eliminating the need to constantly switch between list and form views. The module provides instant access to detailed information, faster data entry, real-time synchronization between list and form views, and a modern dual-panel interface for improved usability. Ideal for sales teams, inventory and warehouse management, procurement, CRM, helpdesk, accounting, and back-office operations, Odoo Split View helps businesses improve efficiency, streamline workflows, and enhance overall productivity.
    tus
    techultra
    techultra_private_limited_solution  
    odoo split view
