...
class BaseModel(models.BaseModel):
    ...
    def web_search_read(self, domain, specification, offset=0, limit=None, order=None, count_limit=None):
        ...
        if all_sort_line_id:
            return super(BaseModel, self).web_search_read(domain=domain, specification=specification, offset=offset,limit=limit,order=all_sort_line_id.fields_id.name + ' ' + all_sort_line_id.order_type,count_limit=count_limit)
