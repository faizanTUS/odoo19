...
{
    'name': 'LinkedIn Integration | Social Post, Image Post & Article Publishing | Content Publishing & HR Recruitment',
    'version': '17.0.0.0',
    'summary': """linkedin linkedin normal post module where company can send updates to linkedin page
