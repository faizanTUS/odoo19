...
# -*- coding: utf-8 -*-
{
    ...
    """,
    "description": """
Mass Attachment Download (Chatter + Binary Fields) | ZIP Export Tool for Odoo 19
=========================================
...
CRM documents, sales order files, HR documents, project files, Odoo 19 productivity,
