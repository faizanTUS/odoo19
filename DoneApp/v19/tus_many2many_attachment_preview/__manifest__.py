...
# -*- coding: utf-8 -*-
{
    ...
    """,
    "description": """
Smart Attachment Preview Pro with File Size Viewer | Chatter & Many2many Binary Viewer | PDF, Image, Video & Office Viewer for Odoo 19
========================================
...
preview, ir.attachment preview, chatter file viewer, productivity, Odoo 19.
...
installation, ``addons_path`` (``odoo19/project``), and ``web.base.url`` setup.
    ...
    "assets": {
        "web.assets_backend": [
            ...
            "tus_many2many_attachment_preview/static/src/js/file_viewer_office_patch.js",
            "tus_many2many_attachment_preview/static/src/xml/many2many_binary_preview.xml",
            "tus_many2many_attachment_preview/static/src/xml/file_viewer_office.xml",
            "tus_many2many_attachment_preview/static/src/models/attachment_list.css",
            "tus_many2many_attachment_preview/static/src/models/attachment_list.xml",
            "tus_many2many_attachment_preview/static/src/models/attachment_size.js",
            "tus_many2many_attachment_preview/static/src/models/messaging_attachment_size.xml",
        ],
    },
    'images': [
