...
class OdooAPI(DataSet):
    ...
    @http.route('/json-call/user_authenticate', type='jsonrpc', auth="public",csrf=False)
    ...
    @http.route(['/json-call/user_logout'], type='jsonrpc', auth="public", csrf=False)
    ...
    @http.route(['/json-call'], type='jsonrpc', auth="public", jsonrpctoken=True, csrf=False)
