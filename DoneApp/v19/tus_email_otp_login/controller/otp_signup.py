...
class OtpSignupHome(Home):
    ...
    def send_signup_mail_otp(self, name, OTP, email, email_from=None):
        ...
        if template:
            ...
            template.with_context(otp=OTP, name=name, email_to=email, email_from=email_from).sudo().send_mail(
            ...
            if otp_no == otp and res_id.expiry_date > datetime.datetime.now():
                ...
                response = request.render("tus_email_otp_login.otp_verification_template", {
                    ...
                    "context": {'otp': True, 'otp_login': True,
                                ...
                                'password': password, 'otp_invalid':True,
