...
sales tax, depending on your business needs or regional requirements.
    ...
    'assets': {
        'point_of_sale._assets_pos': [
            'pos_product_price_display_pro/static/src/app/components/product_card/product_card.xml',
            'pos_product_price_display_pro/static/src/app/components/product_card/product_card.js',
