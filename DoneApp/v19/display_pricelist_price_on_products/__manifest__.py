...
# -*- coding: utf-8 -*-
{
    'name': 'Display Pricelist Prices on Products | Product Pricing Visibility | User Access Control',
    'version': '19.0.0.0',
    ...
    techUltra solutions private limited
    Display Pricelist Prices on Products | Product Pricing Visibility | User Access Control
