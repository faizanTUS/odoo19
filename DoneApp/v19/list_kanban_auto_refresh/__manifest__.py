...
# -*- coding: utf-8 -*-
{
    ...
    """,
    "description": """
Auto Refresh List & Kanban Views | Real-Time Data Reload for Odoo 19
======================================
...
**Keywords (SEO)**
------------------
Odoo 19, list view refresh, kanban refresh, auto reload, soft refresh, live data, interval refresh, tree view, real-time board, productivity, General Settings.
