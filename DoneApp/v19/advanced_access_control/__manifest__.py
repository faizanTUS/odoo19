# Part of Techultra Solutions. See LICENSE file for full copyright and licensing details.
{
    ...
    "summary": """Odoo 19 advanced access rights: per-user model CRUD, field invisible/readonly/required with conditions,
...
**Keywords (SEO / discovery):** Odoo 19 access rights manager, granular permissions, field-level
