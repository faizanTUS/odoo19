...
def post_init_hook(cr, registry):
    ...
    mod = env["ir.module.module"].search([("name", "=", "tus_petty_cash_management")], limit=1)
...
def _create_demo_scenario(env):
    ...
    policy = env.ref("tus_petty_cash_management.demo_petty_cash_policy_standard", raise_if_not_found=False)
    cat_office = env.ref("tus_petty_cash_management.demo_petty_cash_category_office", raise_if_not_found=False)
