...
{
    "name": "Advanced Access Control & UI Restrictions | Hide Chatter, Developer Mode, Buttons, Menus and Actions | Security Policy Manager",
    "version": "18.0.0.0",
    "category": "Administration/Access Rights",
    'author': 'TechUltra Solutions Private Limited',
    'company': 'TechUltra Solutions Private Limited',
    'website': "https://www.techultrasolutions.com/",
    "summary": """Odoo 18 advanced access rights: per-user model CRUD, field invisible/readonly/required with conditions,
    ...
    smart security system
     ...
     """,
    "description": """
Advanced Access Control & UI Restrictions | Hide Chatter, Developer Mode, Buttons, Menus and Actions | Security Policy Manager
=======================================

**Keywords (SEO / discovery):** Odoo 18 access rights manager, granular permissions, field-level
