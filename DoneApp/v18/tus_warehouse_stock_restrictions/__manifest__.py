...
{
    'name': "Warehouse Restriction for User | Stock Location Restriction | Inventory Access Control",
    'version': '18.0.0.0',
    'category': 'Inventory/Stock',
    'summary': """Warehouse Restriction for User | Stock Location Restriction | Inventory Access Control enables administrators to control user access to warehouses, stock locations, picking types, and sale orders. By enforcing user-specific inventory permissions, the module enhances operational security, reduces errors, and ensures efficient management of authorized inventory operations.
        tus
        techultra
    ...
    """,
    'description': """
        Warehouse Restriction for User | Stock Location Restriction | Inventory Access Control is a powerful Odoo access control solution that enables administrators to manage user access to warehouses, stock locations, picking types, and sale orders with precision. By defining user-specific inventory permissions, businesses can improve operational security, reduce processing errors, and ensure users only interact with authorized warehouse and stock operations. This helps maintain better inventory control, streamline workflows, and enhance overall operational efficiency.
        tus
        techultra
        techultra_private_limited_solution
        Warehouse Stock Restrictions
