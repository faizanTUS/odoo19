...
# -*- coding: utf-8 -*-
{
    'name': 'POS Combo Advanced | Bundle & Combo Pricing for Odoo POS',
    'version': '16.0.0.0',
    ...
    POS Combo Advanced | Bundle & Combo Pricing for Odoo POS
    group products
    combo products with groups
    pos combo popup selection
    pos combo products
...
* Keeps existing quantity per combo item and Combo Items tab for standard combos.
    ...
    'assets': {
        'point_of_sale.assets': [
            ...
            'pos_combo_advanced/static/src/js/select_combo_products_popup.js',
            'pos_combo_advanced/static/src/js/combo_product_screen.js',
            'pos_combo_advanced/static/src/xml/select_combo_products_popup.xml',

            'pos_combo_advanced/static/src/js/models.js',
            'pos_combo_advanced/static/src/xml/combo_product_item.xml',
            'pos_combo_advanced/static/src/css/combo_product_badge.css',
