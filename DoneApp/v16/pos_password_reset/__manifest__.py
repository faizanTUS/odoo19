# Part of Odoo. See COPYRIGHT & LICENSE files for full copyright and licensing details.
{
    ...
    "assets": {
        "point_of_sale.assets": [
            "pos_password_reset/static/src/js/reset_button.js",
            "pos_password_reset/static/src/js/reset_password.js",
            "pos_password_reset/static/src/xml/reset_button.xml",
            "pos_password_reset/static/src/xml/reset_popup.xml",
            "pos_password_reset/static/src/js/successful_popup.js",
            "pos_password_reset/static/src/xml/successful_template.xml",
        ],
    },
