...
class GlobalSearchController(http.Controller):
    ...
    def browse(self, model, browse_preset=None, limit=80):
        ...
        try:
            ...
            # Optimization: Never read binary fields (image_1920 / image_128) in search results.
            # It's an order of magnitude faster to let the browser load them as needed via /web/image.
