# Part of Techultra Solutions. See LICENSE file for full copyright and licensing details.
{
    ...
    "summary": """Odoo 16 advanced access rights: per-user model CRUD, field invisible/readonly/required with conditions,
...
**Keywords (SEO / discovery):** Odoo 16 access rights manager, granular permissions, field-level
...
* **Audit (optional):** When enabled on a policy, denied operations (from this module’s rules) are
  logged for review.
    ...
    "assets": {
        "web.assets_backend": [
            "advanced_access_control/static/src/css/aac_style.css",
